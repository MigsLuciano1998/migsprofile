...
function BodyHome() {
  ...
  const websiteDescriptions = [
    ...
    [
      "ZNLRTC Employee DTR",
      "www.dtr.zeldannlrc.com",
      znlrtc,
      "<b>Project Overview</b><br>ZNLRTC is a Finland-focused language training center. They needed an online platform to monitor employees’ daily time records, since staff work in a hybrid setup—both in the office and at home.<br><br><b>Solution</b><br>I developed an online DTR system where employees can log in, start their work time, record breaks, and log out while listing the tasks they completed.<br><br><b>Key Features</b><br>Live monitoring of timed-in employees; undertime and overtime computation; leave filing and approval; schedule change requests; and more.<br><br><b>User Roles</b><br>Super Admin, Admin, and Employee—ensuring smooth management and accountability across the organization.<br><br><b>Tech Stack</b><br>CodeIgniter 3 (PHP framework), AJAX, JavaScript, Bootstrap framework, SMTP for emailing.<br><br>",
    ],
    [
      "ZNLRTC Trainee Monitoring",
      "www.nlrc.ph",
      znlrtc,
